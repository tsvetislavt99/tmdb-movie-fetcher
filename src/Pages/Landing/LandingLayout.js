  ...
  return (
    <div className="flex flex-col lg:flex-row">
      <div className="mx-4 lg:mx-12 lg:basis-1/2 text-white max-lg:mb-5">
        ...
        <p>
          Let's get you started with uploading a{' '}
      ...
      <div className="mx-4 lg:mx-12 lg:basis-1/2">
        <form className="flex flex-col justify-center border border-white rounded-lg bg-gray-400 bg-opacity-50 h-full">
...
etc...`}
          ...
          <button
            className="block  text-white mx-auto mb-4 px-10 py-2 rounded-lg border border-white bg-gradient-to-r from-[#730A82] via-[#4B0A74] to-black hover:scale-105 transition-all duration-300"
            type="submit">
            Upload
          </button>
        </form>
